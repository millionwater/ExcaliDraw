 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */var m,F="[DEFAULT]",De=(m={},m[W]="fire-core",m[Ie]="fire-analytics",m[Oe]="fire-auth",m[_e]="fire-rtdb",m[Ne]="fire-fn",m[Ae]="fire-iid",m[Se]="fire-fcm",m[Re]="fire-perf",m[Ce]="fire-rc",m[Pe]="fire-gcs",m[Le]="fire-fst",m["fire-js"]="fire-js",m[Fe]="fire-js-all",m);/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function ze(r){var e={},t=new Map,n={__esModule:!0,initializeApp:u,app:i,registerVersion:a,setLogLevel:ye,onLog:c,apps:null,SDK_VERSION:je,INTERNAL:{registerComponent:d,removeApp:o,components:t,useAsService:h}};n.default=n,Object.defineProperty(n,"apps",{get:p});function o(f){delete e[f]}function i(f){if(f=f||F,!k(e,f))throw A.create("no-app",{appName:f});return e[f]}i.App=r;function u(f,s){if(s===void 0&&(s={}),typeof s!="object"||s===null){var y=s;s={name:y}}var g=s;g.name===void 0&&(g.name=F);var v=g.name;if(typeof v!="string"||!v)throw A.create("bad-app-name",{appName:String(v)});if(k(e,v))throw A.create("duplicate-app",{appName:v});var I=new r(f,g,n);return e[v]=I,I}function p(){return Object.keys(e).map(function(f){return e[f]})}function d(f){var s=f.name;if(t.has(s))return S.debug("There were multiple attempts to register component "+s+"."),f.type==="PUBLIC"?n[s]:null;if(t.set(s,f),f.type==="PUBLIC"){var y=function(b){if(b===void 0&&(b=i()),typeof b[s]!="function")throw A.create("invalid-app-argument",{appName:s});return b[s]()};f.serviceProps!==void 0&&R(y,f.serviceProps),n[s]=y,r.prototype[s]=function(){for(var b=[],w=0;w<arguments.length;w++)b[w]=arguments[w];var J=this._getService.bind(this,s);return J.apply(this,f.multipleInstances?b:[])}}for(var g=0,v=Object.keys(e);g<v.length;g++){var I=v[g];e[I]._addComponent(f)}return f.type==="PUBLIC"?n[s]:null}function a(f,s,y){var g,v=(g=De[f])!==null&&g!==void 0?g:f;y&&(v+="-"+y);var I=v.match(/\s|\//),b=s.match(/\s|\//);if(I||b){var w=['Unable to register library "'+v+'" with version "'+s+'":'];I&&w.push('library name "'+v+'" contains illegal characters (whitespace or "/")'),I&&b&&w.push("and"),b&&w.push('version name "'+s+'" contains illegal characters (whitespace or "/")'),S.warn(w.join(" "));return}d(new H(v+"-version",function(){return{library:v,version:s}},"VERSION"))}function c(f,s){if(f!==null&&typeof f!="function")throw A.create("invalid-log-argument");be(f,s)}function h(f,s){if(s==="serverAuth")return null;var y=s;return y}return n}/**
 * @license
 * Copyright 2019 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */if(ee()&&self.firebase!==void 0){S.warn(`
    Warning: Firebase is already defined in the global scope. Please make sure
    Firebase library is only loaded once.
  `);var V=self.firebase.SDK_VERSION;V&&V.indexOf("LITE")>=0&&S.warn(`
    Warning: You are trying to load Firebase while using Firebase Performance standalone script.
    You should load Firebase Performance with this instance of Firebase to avoid loading duplicate code.
    `)}var Me=$.initializeApp;$.initializeApp=function(){for(var r=[],e=0;e<arguments.length;e++)r[e]=arguments[e];return Q()&&S.warn(`
...
//# sourceMappingURL=index.esm-7013d418.js.map
